...
class redPipeline2:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_0_hue = [0.0, 15.03030303030303]
        self.__hsv_threshold_0_saturation = [114.65827338129495, 255.0]
        self.__hsv_threshold_0_value = [79.23728813559322, 255.0]

        self.hsv_threshold_0_output = None


        self.__hsv_threshold_1_hue = [168.34532374100718, 180.0]
        self.__hsv_threshold_1_saturation = [116.95143884892086, 255.0]
        self.__hsv_threshold_1_value = [79.23728813559322, 255.0]
        ...
        self.__cv_dilate_iterations = 11.0
