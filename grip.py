...
class BluePipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_0_hue = [76.61870529325746, 127.7815699658703]
        self.__hsv_threshold_0_saturation = [56.56474893041651, 255.0]
        self.__hsv_threshold_0_value = [0.0, 255.0]

        self.hsv_threshold_0_output = None

        self.__mask_input = self.blur_output
        self.__mask_mask = self.hsv_threshold_0_output

        self.mask_output = None

        self.__hsv_threshold_1_input = self.mask_output
        self.__hsv_threshold_1_hue = [93.7853105997635, 114.75936236866016]
        self.__hsv_threshold_1_saturation = [115.25423499823964, 255.0]
        self.__hsv_threshold_1_value = [64.03012801024873, 255.0]

        self.hsv_threshold_1_output = None

        self.__cv_erode_src = self.hsv_threshold_1_output
