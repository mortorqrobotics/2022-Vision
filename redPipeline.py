...
class redPipeline:
    ...
    def __init__(self):
        ...
        self.__blur_radius = 9.909909909909906

        self.blur_output = None

        self.__hsv_threshold_input = self.blur_output
        self.__hsv_threshold_hue = [0.0, 180.0]
        self.__hsv_threshold_saturation = [158.22841726618702, 235.68181818181816]
        ...
        for contour in input_contours:
            ...
            for contour in output:
                ...
                if len(approx)>=8:
                    ...
                    print(circleArea)
                    print(area)
                    if circleArea <= area+30000 and circleArea >= area-30000:
                        contour_list.append(contour)
        return contour_list
